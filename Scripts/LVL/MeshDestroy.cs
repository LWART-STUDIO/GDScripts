...
public class MeshDestroy : MonoBehaviour
{
    ...
    public void DestroyMesh()
    {
        ...
        for (var i = 0; i < parts.Count; i++)
        {
           ...
           // parts[i].GameObject.transform.localScale = new Vector3(0.8f, 0.8f, 0.8f);
            parts[i].GameObject.GetComponent<Rigidbody>().AddForceAtPosition(parts[i].Bounds.center * _explodeForce, transform.position);
            parts[i].GameObject.AddComponent<PartsDestroyer>();
            parts[i].GameObject.layer = 2;
        }
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(MeshDestroy original)
        {
            ...
            meshDestroy._explodeForce = original._explodeForce;
